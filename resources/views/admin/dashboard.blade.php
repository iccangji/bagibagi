...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.competition.index') }}" title="Competition" icon="las la-stream"
                value="{{ $competition['type'] }}" bg="success" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.lottery.index') }}" title="Raffles" icon="las la-ticket-alt"
                value="{{ $competition['lottery'] }}" bg="warning" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.winners.index') }}" title="Declared Winners"
                icon="las la-trophy" value="{{ $competition['winner'] }}" bg="danger" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.setting.general') }}" title="Cart Duration(Minute)"
                icon="las la-shopping-cart" value="{{ gs('cart_duration') }} " bg="primary" outline="true" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
