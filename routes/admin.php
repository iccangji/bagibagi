...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('CompetitionController')->name('competition.')->prefix('competition')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });

    Route::controller('LotteryController')->name('lottery.')->prefix('raffle')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('live', 'live')->name('live');
        Route::get('drawn', 'drawn')->name('drawn');
        Route::get('add/{id?}', 'add')->name('add');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id?}', 'updateStatus')->name('status');
    });

    Route::controller('LotteryController')->prefix('sold')->name('sold.')->group(function () {
        Route::get('tickets', 'soldTickets')->name('tickets');
    });
    Route::controller('LotteryController')->prefix('winners')->name('winners.')->group(function () {
        Route::get('/', 'winners')->name('index');
        Route::get('user/{id}', 'winnerDetail')->name('user.detail');
    });

    Route::controller('TaskController')->prefix('tasks')->name('tasks.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('create', 'create')->name('create');
        Route::post('create', 'store')->name('store');
        Route::get('edit/{task}', 'edit')->name('edit');
        Route::post('destroy/{task}', 'destroy')->name('destroy');
    });
    Route::controller('TaskVerificationController')->prefix('tasks/submission')->name('tasks.submission.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/{userTask}/verify', 'verify')->name('verify');
    });
});
