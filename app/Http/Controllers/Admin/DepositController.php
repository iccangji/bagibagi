...
class DepositController extends Controller
{
    ...
    public function reject(Request $request)
    {
        ...
        // $pickedTickets = PickedTicket::where('deposit_id', $deposit->id)->where('status', Status::PAYMENT_PENDING)->get();

        // foreach ($pickedTickets as $pickedTicket) {
        //     $pickedTicket->lottery->num_of_available_tickets += $pickedTicket->quantity;
        //     $pickedTicket->lottery->save();
        //     $pickedTicket->delete();
        // }
